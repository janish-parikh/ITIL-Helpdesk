# Generated by Django 2.2.18 on 2021-02-22 13:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logging_dir', models.CharField(blank=True, help_text='If logging is enabled, what directory should we use to store log files for this queue? If no directory is set, default to /var/log/helpdesk/', max_length=200, null=True, verbose_name='Logging Directory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Queue', verbose_name='Queue')),
            ],
            options={
                'verbose_name': 'Ticket',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queues', models.ManyToManyField(blank=True, help_text='Leave blank to allow this reply to be used for all queues, or select those queues you wish to limit this reply to.', to='api.Queue')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.KBCategory', verbose_name='Category')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='followup',
            name='ticket',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Ticket', verbose_name='Ticket'),
        ),
        migrations.AddField(
            model_name='followup',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queues', models.ManyToManyField(blank=True, help_text='Leave blank for this exclusion to be applied to all queues, or select those queues you wish to exclude with this entry.', to='api.Queue')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(max_length=1000, upload_to=api.models.attachment_path, verbose_name='File')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('depends_on', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='depends_on', to='api.Ticket', verbose_name='Depends On Ticket')),
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticketdependency', to='api.Ticket', verbose_name='Ticket')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.CustomField', verbose_name='Field')),
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Ticket', verbose_name='Ticket')),
            ],
            options={
